...
button_registr = KeyboardButton(text="Регистрация в телеграмм боте")
...
async def exchange_rates(message: Message):
    url = "https://v6.exchangerate-api.com/v6/1ee7b26ad657e4dbff035915/latest/USD"
    try:
...
async def finances(message: Message, state: FSMContext):
    ...
    await message.answer(f"Категории и расходы сохранены!")
